...
class TestBrewError:
    ...
    def test_message_and_empty_context(self):
    ...
    def test_with_context_merges_and_returns_self(self):
    ...
    def test_with_context_overwrites_existing_key(self):
...
class TestExceptionHierarchy:
    ...
    def test_command_and_timeout_are_transient(self):
    ...
    def test_package_warnings_are_user_errors(self):
    ...
    def test_cache_error_is_sys_error(self):
...
class TestDefaultMessages:
    ...
    def test_brew_command_error_default_message(self):
    ...
    def test_brew_command_error_unknown_returncode(self):
    ...
    def test_package_not_found_with_kind(self):
    ...
    def test_already_installed_message(self):
...
class TestFormatErrorMessage:
    ...
    def test_package_not_found_template(self):
    ...
    def test_brew_command_error_template(self):
    ...
    def test_already_installed_template(self):
    ...
    def test_missing_template_key_falls_back_gracefully(self):
...
def test_suggest_search_mentions_package_and_site():
