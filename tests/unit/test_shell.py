...
def _fake_capture(out: str = "", err: str = "", code: int = 0):
    ...
    async def _capture(*cmd, timeout=None):
        return out, err, code
...
class TestSuccess:
    ...
    async def test_returns_capture_tuple(self, monkeypatch):
...
class TestAlreadyInstalled:
    ...
    async def test_install_already_installed_raises(self, monkeypatch):
    ...
    async def test_only_matched_names_reported(self, monkeypatch):
    ...
    async def test_not_triggered_for_uninstall(self, monkeypatch):
...
class TestPinned:
    ...
    async def test_upgrade_pinned_raises(self, monkeypatch):
    ...
    async def test_pinned_only_for_upgrade(self, monkeypatch):
...
class TestFailure:
    ...
    async def test_nonzero_raises_brew_command_error(self, monkeypatch):
    ...
    async def test_error_prefers_stderr(self, monkeypatch):
    ...
    async def test_matching_is_case_insensitive(self, monkeypatch):
