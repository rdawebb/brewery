...
class TestScanFormulae:
    ...
    def test_basic_formula_from_receipt(self, brew) -> None:
    ...
    def test_version_and_revision_split(self, brew) -> None:
    ...
    def test_head_spec_detected(self, brew) -> None:
    ...
    def test_install_time_from_receipt_epoch(self, brew) -> None:
    ...
    def test_missing_receipt_falls_back_to_mtime(self, brew) -> None:
    ...
    def test_stale_versions_recorded(self, brew) -> None:
    ...
    def test_formula_with_no_keg_is_skipped(self, brew) -> None:
    ...
    def test_empty_cellar_yields_no_formulae(self, brew) -> None:
...
class TestScanCasks:
    ...
    def test_basic_cask(self, brew) -> None:
    ...
    def test_most_recent_version_is_active(self, brew) -> None:
    ...
    def test_cask_with_no_version_dir_skipped(self, brew) -> None:
    ...
    def test_metadata_dir_ignored(self, brew) -> None:
...
class TestLinkPinState:
    ...
    def test_linked_from_bookkeeping(self, brew) -> None:
    ...
    def test_not_linked_when_absent_from_bookkeeping(self, brew) -> None:
    ...
    def test_pinned_flag(self, brew) -> None:
    ...
    def test_not_pinned_by_default(self, brew) -> None:
        """Test that a formula not in the pinned dir is not pinned."""
        brew.formula("wget", "1.0", receipt=full_receipt())
        rec = _by_name(scan_installed(brew.env))["wget"]
        assert rec.pinned is False

    def test_fallback_uses_opt_link_when_no_bookkeeping(self, brew) -> None:
...
class TestIsEffectivelyLinked:
    ...
    def test_missing_opt_link_is_not_linked(self, brew) -> None:
    ...
    def test_opt_link_without_bin_symlink_is_not_linked(self, brew) -> None:
        """Test that an opt link with no bin/sbin symlink is not enough."""
        brew.formula("wget", "1.0", receipt=full_receipt())  # opt link only
        assert is_effectively_linked("wget", brew.env) is False

    def test_opt_link_with_bin_symlink_is_linked(self, brew) -> None:
...
class TestReverseDeps:
    ...
    def test_used_by_populated(self, brew) -> None:
    ...
    def test_tapped_dep_matched_by_leaf_name(self, brew) -> None:
    ...
    def test_no_dependents_is_empty(self, brew) -> None:
